...
export default function Footer() {
  return (
    <footer className="bg-black text-white flex flex-col items-center gap-12 pb-9 md:items-start md:gap-8 md:pb-12 padding-x-mobile md:padding-x-tablet lg:padding-x-desktop">
      ...
      <p className="text-center text-base md:text-start inline-block lg:max-w-xl opacity-50">
