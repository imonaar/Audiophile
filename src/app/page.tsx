...
import { ImageDesktop, ImageMobile, ImageTablet } from "./ui/components/Image"
...
export default function Home() {
  return (
    <main className="">
      ...
      <div className=" grid gap-6 padding-x-mobile md:padding-x-tablet lg:padding-x-desktop">
      ...
      ">
          <div className="w-full h-[237px] flex justify-center lg:flex-1 lg:h-auto relative">
            ...
            {/* <ImageMobile url={assets.zx9.mobile} alt="zx9 speaker" />
          <ImageTablet url={assets.zx9.tablet} alt="zx9 speaker" />
          <ImageDesktop url={assets.zx9.desktop} alt="zx9 speaker" /> */}
          </div>
        ...
        ">
            ...
            <Link href='/' className="px-8 py-4 text-white bg-black uppercase text-sm font-semibold ">
              see product
            </Link>
          </div>
        </div>
